...
class Character(Base):
    ...
    def parse(self, character_page):
        ...
        second_col = \
        character_page.find('div', {'id': 'content'}).find('table').find('tr').find_all('td', recursive=False)[1]
    ...
    def parse_favorites(self, favorites_page):
        ...
        second_col = \
        favorites_page.find('div', {'id': 'content'}).find('table').find('tr').find_all('td', recursive=False)[1]
