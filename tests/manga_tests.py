...
class testMangaClass(object):
    ...
    def testPicture(self):
        assert isinstance(self.holic.picture, str)
        assert isinstance(self.naruto.picture, str)
        assert isinstance(self.monster.picture, str)
        assert isinstance(self.tomoyo_after.picture, str)
        assert isinstance(self.judos.picture, str)
    ...
    #             self.naruto.popular_tags) > 0 and self.action_tag in self.naruto.popular_tags and \
    #            self.naruto.popular_tags[
    #                self.action_tag] >= 561
