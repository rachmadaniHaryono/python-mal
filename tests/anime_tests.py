...
class testAnimeClass(object):
    ...
    def testSynopsis(self):
        assert isinstance(self.spicy_wolf.synopsis, unicode) and len(
            self.spicy_wolf.synopsis) > 0 and u'Holo' in self.spicy_wolf.synopsis
        assert isinstance(self.bebop.synopsis, unicode) and len(
            self.bebop.synopsis) > 0 and u'Spike' in self.bebop.synopsis
        assert isinstance(self.space_dandy.synopsis, unicode) and len(
            self.space_dandy.synopsis) > 0 and u'dandy' in self.space_dandy.synopsis
        assert isinstance(self.totoro.synopsis, unicode) and len(
            self.totoro.synopsis) > 0 and u'Satsuki' in self.totoro.synopsis
        assert isinstance(self.prisma.synopsis, unicode) and len(
