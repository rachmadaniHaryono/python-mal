...
class testUserClass(object):
    ...
    def testPicture(self):
        assert isinstance(self.shal.picture,
                          unicode) and self.shal.picture == u'http://cdn.myanimelist.net/images/userimages/64611.jpg'
    ...
    def testLastListUpdates(self):
        ...
        assert self.shal.last_list_updates[self.fate_zero][u'status'] == u'Watching' and \
               self.shal.last_list_updates[self.fate_zero][u'episodes'] == 6 and \
               self.shal.last_list_updates[self.fate_zero][u'total_episodes'] == 13
        assert isinstance(self.shal.last_list_updates[self.fate_zero][u'time'], datetime.datetime) and \
               self.shal.last_list_updates[self.fate_zero][u'time'] == datetime.datetime(year=2014, month=9, day=5,
        ...
        assert self.shal.last_list_updates[self.bebop][u'status'] == u'Completed' and \
               self.shal.last_list_updates[self.bebop][u'episodes'] == 26 and self.shal.last_list_updates[self.bebop][
                                                                                  u'total_episodes'] == 26
    ...
    def testReviews(self):
        ...
        assert self.smooched.reviews[self.sao][u'people_helped'] >= 259 and self.smooched.reviews[self.sao][
                                                                                u'people_total'] >= 644
        ...
        assert isinstance(self.smooched.reviews[self.sao][u'text'], unicode) and len(
    ...
    def testRecommendations(self):
        ...
        assert isinstance(self.shal.recommendations[self.kanon][u'text'], unicode) and len(
